...
export class CartographieService {
  ...
  getByProjet(projetId: number): Observable<LocaliteIntervention[]> {
    return this.api.get<LocaliteIntervention[]>(this.endpoint, { projetId });
  }

  getByRegion(regionId: number): Observable<LocaliteIntervention[]> {
