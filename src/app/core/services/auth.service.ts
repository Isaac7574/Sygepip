...
export class AuthService {
  ...
  forgotPassword(email?: string): Observable<any> {
    ...
    window.location.href = `${environment.keycloakUrl || environment.keycloakUrl}/realms/sygepip/login-actions/reset-credentials`;
  ...
  changePassword(currentPassword?: string, newPassword?: string): Observable<any> {
    window.location.href = `${environment.keycloakUrl || environment.keycloakUrl}/realms/sygepip/account/password`;
    return of({ success: true });
  }
